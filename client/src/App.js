...
function App() {
    ...
    fetch(`/sale/${saleId}`, {
      ...
      .then((data) => {
        ...
        const productToUpdate = productData.find(
          (product) => product.product_name.toLowerCase() === deletedProductName
        );

        // Update the quantity of the product
        if (productToUpdate) {
          const newQuantity =
            productToUpdate.quantity + parseFloat(deletedSale.sale_quantity);
  ...
  function submitData() {
    ...
    const existingProductIndex = productData.findIndex(
      (product) =>
        new RegExp(product_name.trim(), "i").test(
  ...
  const handleSale = () => {
    ...
    if (!saleProductName) {
      ...
      !productData.some(
        (product) => product.product_name.trim() === saleProductName.trim()
      )
    ) {
  ...
  const handleClientNameChange = (event) => {
    ...
    if (!selectedClientName) {
      ...
      const filteredSuggestions = [...uniqueClientNames].filter((suggestion) =>
        suggestion.toLowerCase().includes(selectedClientName.toLowerCase())
      );
  ...
  const handleSaleProduct = (event) => {
    ...
    if (!selectedProductName) {
      ...
      const filteredSuggestionsB = [...availableProductNames].filter(
        (suggestionA) =>
          suggestionA.toLowerCase().includes(selectedProductName.toLowerCase())
      );
  ...
  const [isSaleProductNameEditEmpty, setIsSaleProductNameEditEmpty] =
    useState(false);
  ...
  const saleUpdate = (i) => {
    ...
    if (
      !productData.some(
        (product) =>
          product.product_name.trim() ===
          editedSaleData[i].sale_product_name.trim()
      )
    ) {
      validSale = false;
    }
              ...
              <div className="contentCenter">
                <Routes>
                  <Route
                    path="/"
                    element={
                      <Home salesData={salesData} productData={productData} />
                    }
                  />
                  <Route
                    path="/stocks"
                    element={
                      <Table
                        ...
                        isProductNameEditEmpty={isProductNameEditEmpty}
                        isQuantityEditEmpty={isQuantityEditEmpty}
                        isBasePriceEditEmpty={isBasePriceEditEmpty}
                        setData={setProductData}
                        setEditingRowIndex={setEditingRowIndex}
                        editingRowIndex={editingRowIndex}
                        handleEditChange={handleEditChange}
                        handleUpdate={handleUpdate}
                        isProductNameEmpty={isProductNameEmpty}
                        isQuantityEmpty={isQuantityEmpty}
                        isBasePriceEmpty={isBasePriceEmpty}
                        onSaleProductNameChange={handleSaleProduct}
                        input={input}
                        onSaleClick={onSaleClick}
                        suggestionsSale={suggestionsSale}
                        data={productData}
                  ...
                  <Route
                    ...
                    element={
                      <SalesTable
                        isSaleProductNameEditEmpty={isSaleProductNameEditEmpty}
                        isSaleQuantityEditEmpty={isSaleQuantityEditEmpty}
                        isSalePriceEditEmpty={isSalePriceEditEmpty}
                        isSaleDateEditEmpty={isSaleDateEditEmpty}
                        isClientNameEditEmpty={isClientNameEditEmpty}
                        saleCancelEdit={saleCancelEdit}
                        saleEdit={saleEdit}
                        saleUpdate={saleUpdate}
                        saleRowIndex={saleRowIndex}
                        setSaleRowIndex={setSaleRowIndex}
                        isSaleProductNameValid={isSaleProductNameValid}
                        isSaleDateEmpty={isSaleDateEmpty}
                        isClientNameEmpty={isClientNameEmpty}
                        isSaleProductNameEmpty={isSaleProductNameEmpty}
                        isSaleQuantityEmpty={isSaleQuantityEmpty}
                        isSalePriceEmpty={isSalePriceEmpty}
                        input={input}
                        onSaleClick={onSaleClick}
                        suggestionsSale={suggestionsSale}
                        value={value}
                        ...
                        availableProductNames={availableProductNames}
                        onSaleDateChange={(e) => setSaleDate(e.target.value)}
                  ...
                  <Route
                    ...
                    element={
                      <ClientTable
                        ...
                        isPaymentDateEmpty={isPaymentDateEmpty}
