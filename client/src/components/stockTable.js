...
const Table = React.memo(
  ({
    handleCancelEdit,
    isProductNameEditEmpty,
    isBasePriceEditEmpty,
    isQuantityEditEmpty,
    handleUpdate,
    setEditingRowIndex,
    editingRowIndex,
          ...
          <div className="add-products">
            ...
            <div className="input-container">
              <input
                ...
                className={`input-field ${
                  isProductNameEmpty ? "input-field-red" : ""
                }`}
                id="input-box"
                value={input}
                ...
                placeholder={
                  isProductNameEmpty
                    ? "Product name can't be left empty"
                    : "Product Name"
                }
                autoComplete="off"
              />
            ...
            <div className="input-container">
              <input
                type="text"
                className={`input-field ${
                  isQuantityEmpty ? "input-field-red" : ""
                }`}
                name="quantity"
                value={quantity}
                onChange={onQuantityChange}
                placeholder={
                  isQuantityEmpty ? "Quantity can't be left empty" : "Quantity"
                }
              />
              <label htmlFor="input-field" className="input-label">
                Quantity
            ...
            <div className="input-container">
              <input
                type="text"
                className={`input-field ${
                  isBasePriceEmpty ? "input-field-red" : ""
                }`}
                name="base-price"
                value={base_price}
                ...
                placeholder={
                  isBasePriceEmpty
                    ? "Base price can't be left empty"
                    : "Base Price"
                }
              />
              <label htmlFor="input-field" className="input-label">
                    ...
                    {editingRowIndex === i ? (
                      <div className="input-container">
                        <input
                          ...
                          className={`input-field ${
                            isProductNameEditEmpty ? "input-field-red" : ""
                          }`}
                          placeholder={
                            isProductNameEditEmpty
                              ? "Product Name"
                          ...
                          onChange={(e) =>
                            handleEditChange(e, i, "product_name")
                          }
                        />
                      </div>
                    ) : (
                    ...
                    {editingRowIndex === i ? (
                      <div className="input-container">
                        <input
                          type="text"
                          className={`input-field ${
                            isQuantityEditEmpty ? "input-field-red" : ""
                          }`}
                    ...
                    {editingRowIndex === i ? (
                      <div className="input-container">
                        <input
                          type="text"
                          className={`input-field ${
                            isBasePriceEditEmpty ? "input-field-red" : ""
                          }`}
